...
const Layout: React.FC = () => {
  ...
  const navigation = [
    ...
    ...(userData?.role === 'team_member' ? [
      { name: 'Submit Task', href: '/submit-task', icon: ClipboardDocumentCheckIcon },
      { name: 'Payment Summary', href: '/payment-summary', icon: CurrencyDollarIcon }
    ] : []),
    ...(userData?.role === 'state_head' ? [
      { name: 'Team Management', href: '/team-management', icon: UserGroupIcon },
      { name: 'Assign Tasks', href: '/assign-tasks', icon: ClipboardDocumentCheckIcon }
    ] : []),
    ...(userData?.role === 'super_admin' ? [
      { name: 'Verification', href: '/verification', icon: CheckCircleIcon },
      { name: 'All Teams', href: '/all-teams', icon: UserGroupIcon }
    ] : []),
